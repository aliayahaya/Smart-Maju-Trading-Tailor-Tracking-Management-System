...
// Fetch admin data
$admin_query = mysqli_query($con, "SELECT * FROM admin") or die(mysqli_error($con));
            ...
            <div class="nav-container w-container">
                <nav role="navigation" class="nav-menu w-nav-menu">
                    <div class="nav-link-wrapper">
                        <a href="management.php" class="nav-link w-nav-link">Back</a>
                        <a href="management.php" class="nav-link move-down hide-on-tab w-nav-link">Back</a>
                    </div>
                    <div class="nav-link-wrapper">
                ...
                <div class="utilities-flex">
                    ...
                    <div class="utilities-wrapper slide-from-right-animation">
                        <div class="utilities-title">
                            <h2>Staff</h2>
                            <p>View, update, and monitor all staff information in one centralized system.</p>
                        </div>
                        <div class="line-spacer">
                            ...
                            <table style="width: 100%; table-layout: auto; border-collapse: collapse; font-family: 'Inter', sans-serif;">
                                ...
                                <tbody>
                                    <?php while ($order = mysqli_fetch_assoc($admin_query)): ?>
                                    <tr style="border-bottom: 1px solid #f1d9b4ff;">
                                        <td style="padding: 12px;"><?php echo $order['admin_id']; ?></td>
                                        <td style="padding: 12px;"><?php echo $order['admin_name']; ?></td>
                                        <td style="padding: 12px;"><?php echo $order['admin_phone']; ?></td>
                                        <td style="padding: 12px;"><?php echo $order['admin_email']; ?></td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
                            </table>
                            <!-- PDF Download Button -->
                            <a href="generate admin pdf.php" class="btn btn-primary" target="_blank" style="margin-top: 10px; display: inline-block;">Download PDF</a>
                            <br><br>
                        </div>
                            ...
                            <thead>
                                <tr style="background-color: #c69b6b; color: white; text-align: left;">
                                    <th style="padding: 12px;">Tailor ID</th>
                                    <th style="padding: 12px;">Name</th>
                                    <th style="padding: 12px;">Phone</th>
                                    <th style="padding: 12px;">Email</th>
                                </tr>
                            ...
                            <tbody>
                                <?php while ($order = mysqli_fetch_assoc($tailor_query)): ?>
                                <tr style="border-bottom: 1px solid #f1d9b4ff;">
                                    <td style="padding: 12px;"><?php echo $order['tailor_id']; ?></td>
                                    <td style="padding: 12px;"><?php echo $order['tailor_name']; ?></td>
                                    <td style="padding: 12px;"><?php echo $order['tailor_phone']; ?></td>
                                    <td style="padding: 12px;"><?php echo $order['tailor_email']; ?></td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
                        </table>
                        <!-- PDF Download Button -->
                        <a href="generate tailor pdf.php" class="btn btn-primary" target="_blank" style="margin-top: 10px; display: inline-block;">Download PDF</a>
                        <br><br>
            ...
            <div data-w-id="fa36639f-bc34-8f1a-4024-d088998077f8" class="footer-top">
                <div class="footer-block">
                    ...
                    <div class="footer-right-flex">
                        <div class="footer-wrapper">
                            ...
                            <div class="footer-link-wrapper">
                                <a href="management.php" class="footer-link">Back</a>
                                <a href="management.php" class="footer-link move-down">Back</a>
                            </div>
                            <div class="footer-link-wrapper">
                    ...
                    <div data-w-id="fa36639f-bc34-8f1a-4024-d0889980784c" class="footer-bottom">
                        <p class="font-white">© 2025 Smart Trading. All Rights Reserved. </p>
