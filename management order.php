...
$orders_query = mysqli_query($con, "SELECT * FROM `order` WHERE status = 'Pick-Up'") or die(mysqli_error($con));

// Fetch complete orders
$ongoing_orders_query = mysqli_query($con, "SELECT * FROM `order` WHERE status != 'Pick-Up'") or die(mysqli_error($con));
?>
<!DOCTYPE html>
    ...
    <body>
        <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="medium" data-w-id="06ab6c64-468c-b44e-1b8c-856deb96ba7f" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
            <a href="/" aria-current="page" class="logo-link-wrapper w-nav-brand w--current">
                <img src="logo.jpg" alt="Logo.jpg" class="logo.jpg" style="width: auto; height: 100px; max-height: none;">
            </a>
                ...
                <div class="utilities-flex">
                    ...
                    <div class="utilities-wrapper slide-from-right-animation">
                        <div class="utilities-title">
                            <h2>Order</h2>
                            <p>Generate and manage completed tailoring orders with real-time updates.</p>
                        </div>
                        <div class="line-spacer">
                            ...
                            <table style="width: 100%; table-layout: auto; border-collapse: collapse; font-family: 'Inter', sans-serif;">
                                ...
                                <tbody>
                                    <?php while ($order = mysqli_fetch_assoc($ongoing_orders_query)): ?>
                            ...
                            <table style="width: 100%; table-layout: auto; border-collapse: collapse; font-family: 'Inter', sans-serif;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 1px solid #f1d9b4ff;">
                                        ...
                                        <td style="padding: 12px;"><?php echo $order['quantity']; ?></td>
                                        <td style="padding: 12px;"><?php echo $order['status']; ?></td>
                                        <td style="padding: 12px;"><?php echo $order['amount_paid']; ?></td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
                            </table>
                            <!-- PDF Download Button -->
                            <a href="generate order pdf.php" class="btn btn-primary" target="_blank" style="margin-top: 10px; display: inline-block;">Download PDF</a>
                            <br><br>
                        </div>
                            <div class="space-4rem">
