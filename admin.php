    ...
    <body>
            ...
            <div class="nav-container w-container">
                <nav role="navigation" class="nav-menu w-nav-menu">
                    ...
                    <div class="nav-link-wrapper">
                        <a href="logout.php" class="nav-link w-nav-link">Logout
        ...
        <section class="section">
            <div class="w-layout-blockcontainer container padding-9rem w-container">
                ...
                <div class="title-block flip-from-bottom-animation">
                    <div class="subheading-flex">
                        
                        <h1>Administration</h1>
                    </div>
                    <h5 class="max-width-2rem">Centralized control of ordering operations for efficient tailoring service delivery.</h5>
                    <div class="space-0-5rem">
                    </div>
        ...
        <section class="section">
            <div class="w-layout-blockcontainer container background-black rounded-corners w-container">
                <div class="space-7rem">
        ...
        <section class="section background-black">
            <div class="w-layout-blockcontainer container padding-4-5rem w-container">
                <div class="metrics-grid-quarter">
                    <div data-w-id="cf2a3ee0-14b5-9c0d-9642-1e4940080d73" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="metrics-card background-secondary">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c41_double_arrow.svg" loading="eager" class="large-icon invert">
                        <h4 class="caps font-white">View Order</h4>
                        <a href="view order.php" data-w-id="5636032a-1271-e473-ecbe-20e393bd2447" class="button-with-circle-icon w-inline-block">
                        <p class="button-text">Click here</p>
                        <p class="button-text-absolute">Click here</p>
                        <div class="button-arrow-wrapper">
                            <img width="Auto" height="Auto" alt="" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" loading="eager" class="arrow"/>
                        </div>
                    </a>
                    </div>
                    <div data-w-id="cf2a3ee0-14b5-9c0d-9642-1e4940080d5b" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="metrics-card">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c42_azm.svg" loading="eager" class="large-icon">
                        <h4 class="caps">New Order</h4>
                        <a href="new order.php" data-w-id="5636032a-1271-e473-ecbe-20e393bd2447" class="button-with-circle-icon w-inline-block">
                        <p class="button-text">Click here</p>
                        <p class="button-text-absolute">Click here</p>
                        <div class="button-arrow-wrapper">
                            <img width="Auto" height="Auto" alt="" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" loading="eager" class="arrow"/>
                    ...
                    <div data-w-id="cf2a3ee0-14b5-9c0d-9642-1e4940080d73" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="metrics-card background-secondary">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c41_double_arrow.svg" loading="eager" class="large-icon invert">
                        <h4 class="caps font-white">Update Order</h4>
                        <a href="update order.php" data-w-id="5636032a-1271-e473-ecbe-20e393bd2447" class="button-with-circle-icon w-inline-block">
                        <p class="button-text">Click here</p>
                        <p class="button-text-absolute">Click here</p>
                        <div class="button-arrow-wrapper">
                            <img width="Auto" height="Auto" alt="" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" loading="eager" class="arrow"/>
                    ...
                    <div data-w-id="cf2a3ee0-14b5-9c0d-9642-1e4940080d5b" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="metrics-card">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c42_azm.svg" loading="eager" class="large-icon">
                        <h4 class="caps">Pick-Up Order</h4>
                        <a href="pickup order.php" data-w-id="5636032a-1271-e473-ecbe-20e393bd2447" class="button-with-circle-icon w-inline-block">
                        <p class="button-text">Click here</p>
                        <p class="button-text-absolute">Click here</p>
                        <div class="button-arrow-wrapper">
                            <img width="Auto" height="Auto" alt="" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" loading="eager" class="arrow"/>
                    ...
                    <div data-w-id="cf2a3ee0-14b5-9c0d-9642-1e4940080d73" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="metrics-card background-secondary">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c41_double_arrow.svg" loading="eager" class="large-icon invert">
                        <h4 class="caps font-white">View Tailor</h4>
                        <a href="staff_order.php" data-w-id="5636032a-1271-e473-ecbe-20e393bd2447" class="button-with-circle-icon w-inline-block">
                        <p class="button-text">Click here</p>
                        <p class="button-text-absolute">Click here</p>
                        <div class="button-arrow-wrapper">
                            <img width="Auto" height="Auto" alt="" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" loading="eager" class="arrow"/>
                    ...
                    <div class="metrics-card light-theme">
                        <img width="Auto" height="Auto" alt="icon" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c42_azm.svg" loading="eager" class="large-icon">
                        <h4 class="caps">MANAGEMENT</h4>
                        <a href="management.php" class="button-with-circle-icon w-inline-block">
                            <p class="button-text">Click here</p>
                            <div class="button-arrow-wrapper">
                                <img alt="arrow" src="https://cdn.prod.website-files.com/685c1e8eae4696d62caa7b3f/685c1e8fae4696d62caa7c08_arrow_outward.svg" class="arrow">
                            </div>
                        </a>
                    </div>
