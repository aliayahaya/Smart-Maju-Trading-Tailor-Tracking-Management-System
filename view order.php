...
$orders_query = mysqli_query($con, "SELECT * FROM `order`") or die(mysqli_error($con));
?>
<!DOCTYPE html>
                    ...
                    <div class="footer-right-flex">
                        <div class="footer-wrapper">
                            ...
                            <div class="footer-link-wrapper">
                                <a href="admin.php" aria-current="page" class="footer-link w--current">Home</a>
                                <a href="admin.php" aria-current="page" class="footer-link move-down w--current">Home</a>
                            </div>
                            <div class="footer-link-wrapper">
